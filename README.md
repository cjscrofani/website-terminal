...
Built with:
- [Radix UI](https://www.radix-ui.com/) - Headless dialog component
- [Lucide React](https://lucide.dev/) - Beautiful icons
- [Next.js](https://nextjs.org/) - React framework

## Support

- 📝 [Documentation](https://github.com/cjscrofani/react-terminal-search#readme)
- 🐛 [Issue Tracker](https://github.com/cjscrofani/react-terminal-search/issues)
- 💬 [Discussions](https://github.com/cjscrofani/react-terminal-search/discussions)

---

Made with ❤️ by [CJ Scrofani](https://cjscrofani.com)
